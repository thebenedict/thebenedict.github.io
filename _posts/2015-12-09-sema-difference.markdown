...
<div class="caption with-spacing">Counts of the selected term from September 15 - November 15, with English publications above the x-axis and Swahili publications below. Select different terms from the dropdown, and click the legend to toggle publications.</div>
...
<div class="select-wrapper">
  <div class="label">Table of term counts by publisher:</div>
  <select id="table-select">
    <option value="nation">Nation media (Citizen/Mwananchi)</option>
    <option value="ipp">IPP media (Guardian/Nipashe)</option>
    <option value="tsn">TSN (Daily News, Habarileo)</option>
...
<p><div class="caption">All headlines from articles mentioning Zanzibar, scraped on October 30. Publications marked * are translated from Swahili.</div></p>
